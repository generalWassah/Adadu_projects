   ...
   public North(String text){
    ...
    public String getLastOrbit(int dIndex){
        ...
        if(this.initText.length()%2==0) {
            ...
            lastOrbit = formatter.format(south.getFirstOrbit(dIndex));
        }else{
            NorthReversed northReversed = new NorthReversed(this.initText);
            lastOrbit = formatter.format(northReversed.getFirstOrbit(dIndex));
        }
