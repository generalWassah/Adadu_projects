...
public class RightWard {
    ...
    public String getRightWardDiffusion(String selectNEWS) {
        ...
        while(iter>0){
            ...
            newDiffusedText = news.diffuseExtract(extract,selectNEWS);
    ...
    public String getLastOrbit(String selectNEWS){
        this.initText = this.text;
        RightWardReversed rightWardReversed = new RightWardReversed(this.initText);
        String lastOrbit="";
