...
*/
    ...
    public String getLastOrbit(int dIndex){
        ...
        if(this.initText.length()%2==0) {
            ...
            lastOrbit = formatter.format(east.getFirstOrbit(dIndex));
        }else{
            WestReversed westReversed = new WestReversed(this.initText);
            lastOrbit = formatter.format(westReversed.getFirstOrbit(dIndex));
        }
        return lastOrbit;
    }
